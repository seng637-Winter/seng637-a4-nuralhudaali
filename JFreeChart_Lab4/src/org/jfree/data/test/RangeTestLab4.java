...
// Test of the shift method for code coverage
 ...
 // --------------------------------------------------------------------------------------------
 // Lab 4: Additional Test Cases for Mutant Testing
    
    @Test
    public void getLengthNormalRangeReturnsLength() {
        // setup
    ...
    @Test
    public void getCentralValueNormalRangeReturnsCentralValue() {
        // setup
        Range range = new Range(5.0, 10.0);
        ...
        // verify
        assertEquals(7.5, centralValue, 0.0001);
    ...
    @Test
    public void getCentralValueZeroRangeReturnsZero() {
        // setup
        ...
        // verify
        assertEquals(0.0, centralValue, 0.0001);
    ...
    @Test
    public void intersectsLowerBoundBelowRangeReturnsFalse() {
        // setup
        Range range = new Range(5.0, 10.0);
        
        // exercise
        boolean intersects = range.intersects(10.0, 11.0);
    ...
    @Test
    public void intersectsUpperBoundAboveRangeReturnsFalse() {
        // setup
        Range range = new Range(5.0, 10.0);
        
        // exercise
        boolean intersects = range.intersects(11.0, 8.0);
    ...
    @Test
    public void intersectsBoundsWithinRangeReturnsTrue() {
        // setup
        Range range = new Range(5.0, 10.0);
        
        // exercise
        boolean intersects = range.intersects(7.0, 8.0);
    ...
    @Test
    public void constrainValueAboveUpperBoundReturnsUpperBound() {
        // setup
        Range range = new Range(5.0, 10.0);
        
        // exercise
        double constrainedValue = range.constrain(11.0);
    ...
    @Test
    public void constrainValueBelowLowerBoundReturnsLowerBound() {
        // setup
        Range range = new Range(5.0, 10.0);
        
        // exercise
        double constrainedValue = range.constrain(4.0);
    ...
    @Test
    public void expandToIncludeNullRangeReturnsNewRangeWithSingleValue() {
    	// @Before: exampleRange [-1, 1]
    ...
    @Test
    public void expandToIncludeValueBelowLowerBoundReturnsNewRangeWithExpandedLowerBound() {
        // setup
        Range range = new Range(5.0, 10.0);
        
        // exercise
        Range expandedRange = Range.expandToInclude(range, 4.0);
        
        // verify
        assertEquals(4.0, expandedRange.getLowerBound(), 0.0001);
    ...
    @Test
    public void expandToIncludeValueAboveUpperBoundReturnsNewRangeWithExpandedUpperBound() {
        // setup
        Range range = new Range(5.0, 10.0);
        
        // exercise
        Range expandedRange = Range.expandToInclude(range, 11.0);
    ...
    @Test
    public void expandNegativeMarginsLowerBiggerThanUpper() {
        // setup
        ...
        // exercise
        Range resultRange = Range.expand(range, lowerMargin, upperMargin);
    ...
    @Test
    public void isNaNRangeWithNaNRange() {
        // setup
    ...
    @Test
    public void isNaNRangeUpperNaNBoundOnly() {
        // setup
    ...
    @Test
    public void isNaNRangeLowerNaNBoundOnly() {
        // setup
        Range range = new Range(Double.NaN, 30);
    ...
    @Test
    public void isNaNRangeWithNonNaNRange() {
        // setup
    ...
    @Test
    public void intersectLowerBoundLessThanRangeLowerBound() {
    	// setup
        Range range = new Range(0, 10);
        
        // exercise
        boolean result = range.intersects(-1, 5);
    ...
    @Test
    public void intersectLowerBoundGreaterThanRangeLowerBound() {
    	// setup
        Range range = new Range(0, 10);
        
        // exercise
        boolean result = range.intersects(2, 5);
    ...
    @Test
    public void intersectLowerBoundGreaterThanRangeLowerBoundAndGreaterThanUpperBound() {
    	// setup
        Range range = new Range(0, 10);
        
        // exercise
        boolean result = range.intersects(7, 5);
    ...
    @Test
    public void testMinFirstArgumentIsNaNReturnsSecondArgument() {
        // exercise
        double minValue = Range.min(Double.NaN, 10.0);
        
        // verify
        assertEquals(10.0, minValue, 0.0001);
    }

    @Test
    public void testMinSecondArgumentIsNaNReturnsFirstArgument() {
        // exercise
        double minValue = Range.min(5.0, Double.NaN);
        
        // verify
        assertEquals(5.0, minValue, 0.0001);
    }

    @Test
    public void testMaxFirstArgumentIsNaNReturnsSecondArgument() {
        // exercise
        double maxValue = Range.max(Double.NaN, 10.0);
        
        // verify
        assertEquals(10.0, maxValue, 0.0001);
    }

    @Test
    public void maxSecondArgumentIsNaNReturnsFirstArgument() {
        // exercise
        double maxValue = Range.max(5.0, Double.NaN);
        
        // verify
        assertEquals(5.0, maxValue, 0.0001);
    }
